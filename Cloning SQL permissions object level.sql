...
SET @OldUser = 'TMKMHC\E8L' --The user or role from which to copy the permissions from
SET @NewUser = 'TMKMHC\ROV'  --The user or role to which to copy the permissions to
